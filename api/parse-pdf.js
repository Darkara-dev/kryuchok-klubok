...
4. Переведи вязальные обозначения на русский:
   ...
   inc → "прибавка"
   dec → "убавка"
   BLO/back loop only → "ЗП" (за заднюю полупетлю)
   FLO/front loop only → "ПП" (за переднюю полупетлю)
   Формулируй описание по-русски естественно, например "(2 сбн, прибавка) x6" вместо дословного перевода отдельных слов.
